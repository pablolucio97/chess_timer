...
export default function BlackWins() {

    const blackPieciesImg = require('../assets/img/chess_black.png') 
    ...
    return (
        <View style={styles.mainContainer}>
            ...
            />
            <Text style={styles.text}>Peças pretas venceu esta partida!</Text>
            <Image source={blackPieciesImg} style={{width: 100, height: 100, alignSelf: 'center'}}/>
            <LottieView
                resizeMode='center'
                speed={.7}
